...
final class AppDelegate: NSObject, NSApplicationDelegate, UNUserNotificationCenterDelegate, NSMenuItemValidation, NSMenuDelegate {
    ...
    /// session is still restoring (apply nothing until it settles). Pure so it
    /// is unit-testable without the coordinator or the PostHog SDK.
    static func resolveAnalyticsIdentity(
